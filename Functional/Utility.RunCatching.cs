...
partial class Utility
{
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2, value3));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2, value3, value4));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2, value3, value4, value5));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2, value3, value4, value5, value6));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2, value3, value4, value5, value6, value7));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
    ...
    )
    {
        try
        {
            return Either.Right(fn(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        catch (Exception exception)
        {
            return Either.Left(exception);
