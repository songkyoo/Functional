...
partial class Utility
{
    ...
    public static void Use<T1, T2>(
        ...
        where T2 : IDisposable
    {
        using (disposable.Item1)
        using (disposable.Item2)
        {
            action(disposable.Item1, disposable.Item2);
        }
    }
        ...
        where T3 : IDisposable
    {
        using (disposable.Item1)
        using (disposable.Item2)
        using (disposable.Item3)
        {
            action(disposable.Item1, disposable.Item2, disposable.Item3);
        }
    }
        ...
        where T4 : IDisposable
    {
        ...
        {
            action(disposable.Item1, disposable.Item2, disposable.Item3, disposable.Item4);
        }
    }
        ...
        where T5 : IDisposable
    {
        ...
        {
            action(disposable.Item1, disposable.Item2, disposable.Item3, disposable.Item4, disposable.Item5);
        }
    }
        ...
        where T2 : IDisposable
    {
        ...
        using (disposable.Item2)
        {
            return fn(disposable.Item1, disposable.Item2);
        }
    }
        ...
        where T3 : IDisposable
    {
        ...
        using (disposable.Item3)
        {
            return fn(disposable.Item1, disposable.Item2, disposable.Item3);
        }
    }
        ...
        where T4 : IDisposable
    {
        ...
        using (disposable.Item4)
        {
            return fn(disposable.Item1, disposable.Item2, disposable.Item3, disposable.Item4);
        }
    }
